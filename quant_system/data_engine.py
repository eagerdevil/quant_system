...
KEY_ETFS = {
    ...
    "512760": "芯片ETF国泰",         # 用户指定
    "518850": "黄金ETF华夏",         # 用户已清仓（继续观察）
    "159326": "电网设备ETF华夏",     # 用户已清仓（7/21止损-21%）
    "159227": "航空航天ETF华夏",     # 用户指定
    "515070": "人工智能ETF华夏",     # 用户指定
    "159183": "新能源车ETF招商",     # 用户已清仓
    "159659": "纳斯达克100ETF招商",  # 用户已清仓（8/3，继续观察）
    "510300": "沪深300ETF华泰柏瑞",  # 用户已清仓（8/5，继续观察）

    # === 宽基指数 ===
    "510500": "中证500ETF", "159915": "创业板ETF",
    "588000": "科创50ETF", "512100": "中证1000ETF南方",
    ...
    "513800": "日本东证指数ETF南方",   # 全球关注
    "159529": "标普消费ETF景顺",       # 全球关注
    "159750": "港股科技50ETF招商",     # 全球关注

    # === 消费 ===
    "515650": "消费50ETF富国",         # 全球关注
...
USER_WATCHLIST = [
    ...
    "159659",   # 纳斯达克100ETF招商（已清仓，继续观察）
    "510300",   # 沪深300ETF华泰柏瑞（已清仓，继续观察）
    "515650",   # 消费50ETF富国（全球关注）
    "159750",   # 港股科技50ETF招商（全球关注）
    "513800",   # 日本东证指数ETF南方（全球关注）
    "159529",   # 标普消费ETF景顺（全球关注）
    "512100",   # 中证1000ETF南方（全球关注）
]
