...
# 8/14 池调整: 移除纳指重复(513100)/中证1000华夏(159845)/科创50易方达(588050), 新增欧洲/黄金/恒生宽基/国债
USER_WATCHLIST = [
    "510500",   # 中证500ETF（A股宽基）
    "512100",   # 中证1000ETF南方（A股宽基）
    "563360",   # A500ETF华泰柏瑞（A股宽基，8/24替代510300）
    "159915",   # 创业板ETF（A股宽基）
    "588000",   # 科创50ETF（A股宽基）
    ...
    "513180",   # 恒生科技ETF（港股）
    "159920",   # 恒生ETF（港股宽基）
    "513030",   # 德国DAX30ETF华安（欧洲）
    "518880",   # 黄金ETF华安（大类资产）
    "161226",   # 白银基金（大类资产）8/24新增
    "511010",   # 国债ETF国泰（大类资产）
    "511260",   # 十年国债ETF国泰（大类资产）8/24新增
    "512890",   # 红利低波ETF华泰柏瑞（A股红利策略）8/24新增
    "513530",   # 港股通红利ETF华泰柏瑞（港股红利）8/24新增
    "159750",   # 港股科技50ETF招商（港股，实盘持仓）
    "159529",   # 标普消费ETF景顺（美股，实盘持仓）
]

# 个股关注（独立处理）
# 9/21: 用户指定长期关注三个个股(资金充足后计划买入)。入此表后每日日报会
#       采集行情+评分, 并出现在邮件/报告的"个股评分"区。
#   600900 长江电力 — 已持仓(9/21建仓)。同时列入关注, 日后若卖出仍继续跟踪
#   002594 比亚迪   — 观察中, 未持仓
#   000333 美的集团 — 观察中, 未持仓
# 9/22: 移除 000995 皇台酒业 — 7/26 v3.1 遗留的开发占位项, 非用户关注标的
USER_STOCKS = {
    "600900": "长江电力",
    "002594": "比亚迪",
    "000333": "美的集团",
...
QDII_ETF_CODES = {
    ...
    "159659", "513500",
    # 恒生/中概/港股通
    "513180", "513130", "513050", "159750", "159920", "513530",
    # 日经/东证
    "513520", "513800",
    # 欧洲
    "513030",
